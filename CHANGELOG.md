...
## v1.2.0
  ...
  * Adds `automatic_keys` to metadata for streams, including reports. Fixes a bug with the ad_group_ad attributed resource in reports to ensure field name consistency. Updates tests [#55](https://github.com/singer-io/tap-google-ads/pull/55)

...
class TesGoogleAdstPagination(GoogleAdsBase):
    ...
    def test_run(self):
        ...
        # We do not have enough records for accounts, bidding_strategies, feed, and user_list streams.
        streams_to_test = streams_to_test - {'accounts', 'bidding_strategies', 'feed', 'user_list'}
